    ...
    pointerInput(Unit) {
        detectDragGestures(
            ...
            onDrag = { change, dragAmount ->
                ...
                // Set it to 'dragAmount' to drag in all directions
                val horizontalOnlyDrag = Offset(dragAmount.x, 0f)
                velocity = horizontalOnlyDrag
                scope.launch { state.drag(MutatePriority.UserInput) { dragBy(horizontalOnlyDrag) } }
            },
